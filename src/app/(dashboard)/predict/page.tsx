      ...
      <form onSubmit={handleSubmit} className="mt-8 grid gap-6 lg:grid-cols-[1.6fr_1fr]">
        ...
        <div className="space-y-6">
            ...
            <div className="grid gap-5 sm:grid-cols-2">
              <div>
                ...
                <select
                  ...
                  className="mt-1.5 h-12 w-full rounded-xl border border-border bg-surface/60 px-4 text-sm outline-none transition-all focus:border-ring focus:shadow-[0_0_0_4px_color-mix(in_oklab,hsl(var(--ring))_20%,transparent)]"
                >
                  {ACCOUNTS.map((a) => (
                  ...
                  return (
                    <button
                      ...
                      className={`group relative overflow-hidden rounded-xl border p-4 text-left transition-all active:scale-[0.98] ${
                        active
                          ? "border-primary bg-[color-mix(in_oklab,hsl(var(--primary))_10%,transparent)] shadow-[var(--shadow-glow-purple)]"
          ...
          >
            ...
            <div className="mt-1.5 rounded-xl border border-border bg-surface/60 transition-all focus-within:border-ring focus-within:shadow-[0_0_0_4px_color-mix(in_oklab,hsl(var(--ring))_20%,transparent)]">
              <textarea
                value={caption}
