    ...
    <div className="px-5 py-6 md:px-10 md:py-8">
        ...
        <div className="relative flex w-full flex-col overflow-hidden rounded-[22px] p-6 md:p-12">
          ...
          <div className="relative z-10 flex flex-wrap items-start justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              {driftCount > 0 && (
                <div className="inline-flex items-center gap-2 rounded-full border border-[color-mix(in_oklab,hsl(var(--destructive))_45%,transparent)] bg-[color-mix(in_oklab,hsl(var(--destructive))_10%,transparent)] px-3 py-1.5 text-[11px] font-semibold text-destructive backdrop-blur">
            ...
            >
              ...
              <div className="relative">
                <div className="flex items-start justify-between gap-2">
                  <div className="grid h-9 w-9 place-items-center rounded-xl bg-[color-mix(in_oklab,hsl(var(--primary))_10%,transparent)] text-primary">
                    <KpiIcon className="h-[18px] w-[18px]" />
                  </div>
                  <div
                    className={`inline-flex items-center gap-0.5 rounded-full px-2 py-0.5 text-[10px] font-semibold ${
                      kpi.trend === "up"
                        ? "bg-[color-mix(in_oklab,hsl(var(--success))_15%,transparent)] text-[oklch(0.55_0.18_150)] dark:text-[oklch(0.78_0.18_150)]"
                        : "bg-[color-mix(in_oklab,hsl(var(--destructive))_15%,transparent)] text-[oklch(0.55_0.22_22)] dark:text-[oklch(0.78_0.22_22)]"
                    }`}
                  >
                    {kpi.trend === "up" ? (
              ...
              <AreaChart data={USAGE_TREND} margin={{ top: 10, right: 8, left: -10, bottom: 0 }}>
                <defs>
                  ...
                  <linearGradient id="high-grad" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stopColor="hsl(95 75% 68%)" stopOpacity={0.45} />
                    <stop offset="100%" stopColor="hsl(95 75% 68%)" stopOpacity={0} />
                  </linearGradient>
                </defs>
                <CartesianGrid stroke="hsl(280 8% 14% / 0.06)" vertical={false} />
                <XAxis dataKey="day" stroke="hsl(280 4% 44%)" fontSize={11} tickLine={false} axisLine={false} />
                <YAxis stroke="hsl(280 4% 44%)" fontSize={11} tickLine={false} axisLine={false} />
                <Tooltip
                  contentStyle={{
                  ...
                  cursor={{ stroke: "hsl(272 62% 47%)", strokeWidth: 1, strokeDasharray: "3 3" }}
                />
                <Area type="monotone" dataKey="predictions" stroke="hsl(272 62% 47%)" strokeWidth={2} fill="url(#pred-grad)" />
                <Area type="monotone" dataKey="high" stroke="hsl(95 75% 68%)" strokeWidth={2} fill="url(#high-grad)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
      ...
      <section className="mb-10 rounded-2xl border border-border bg-surface/70 p-6 backdrop-blur-xl">
        <div className="mb-5 flex items-start justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-1.5 rounded-full border border-[color-mix(in_oklab,hsl(var(--primary))_30%,transparent)] bg-[color-mix(in_oklab,hsl(var(--primary))_8%,transparent)] px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-primary">
          ...
          <Link href="/niches" className="shrink-0 text-xs font-medium text-primary hover:underline">
            Manage brands →
          </Link>
        </div>
              ...
              >
                ...
                <div className="mt-3 flex items-center justify-between text-[11px]">
                  ...
                  <span className="inline-flex items-center gap-1.5 font-mono text-foreground">
                    ...
                    {b.drift && (
                      <span className="inline-flex items-center gap-1 rounded-full bg-[color-mix(in_oklab,hsl(var(--destructive))_18%,transparent)] px-1.5 py-0.5 text-[9px] font-semibold uppercase text-destructive animate-pulse">
