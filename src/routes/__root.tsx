...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "FAIV" },
      { property: "og:title", content: "FAIV Predict — AI content performance prediction" },
      {
        property: "og:description",
        content:
          "Predict virality, diagnose performance, and optimize captions before you post.",
      },
